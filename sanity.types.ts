...
// Query: *[_type=="sale"                && isActive == true                && couponCode == $couponCode                ] | order(validFrom desc)             //      {            //   _id,  title,description,discountAmount,couponCode,validFrom,validUntill,isActive            //      }            // pulling the first object                [0]
